...
class ImmigrationCaseFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'stage' => fake()->optional(0.7)->randomElement(array_keys(ImmigrationCase::STAGE_LABELS)),
            'ircc_status' => fake()->optional(0.7)->randomElement(array_keys(ImmigrationCase::IRCC_STATUS_LABELS)),
            'final_result' => fake()->optional(0.2)->randomElement([ImmigrationCase::FINAL_RESULT_APPROVED, ImmigrationCase::FINAL_RESULT_DENIED]),
            'ircc_code' => fake()->optional(0.5)->bothify('B######'),
            'archive_box_number' => $isClosed ? fake()->bothify('BOX-###') : null,
            'contract_number' => fake()->optional(0.6)->bothify('CTR-####-???'),
            'service_type' => fake()->randomElement([ImmigrationCase::SERVICE_TYPE_PRO_BONO, ImmigrationCase::SERVICE_TYPE_FEE_BASED]),
            'fees' => fake()->optional(0.7)->randomFloat(2, 500, 5000),
