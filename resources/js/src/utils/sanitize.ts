...
export function sanitizeHtml(dirty: string | null | undefined): string {
    ...
    return DOMPurify.sanitize(dirty, {
        ...
        ALLOWED_ATTR: ['href', 'target', 'rel', 'class', 'style', 'src', 'alt', 'width', 'height', 'viewBox', 'fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'd', 'cx', 'cy', 'r', 'x', 'y', 'x1', 'y1', 'x2', 'y2', 'points', 'xmlns', 'transform', 'id', 'version', 'opacity', 'fill-rule', 'clip-rule', 'clip-path'],
    });
}
