            ...
            >
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <!-- Success Message -->
                        <div v-if="authStore.passwordResetMessage && !authStore.error" class="mb-5 rounded-md bg-success-light p-4 text-success">
                            <p>{{ authStore.passwordResetMessage }}</p>
                            <router-link to="/auth/boxed-signin" class="mt-2 inline-block font-semibold underline">
                                Back to Sign In
                            </router-link>
                        </div>
                        ...
                        <form v-if="!authStore.passwordResetMessage" class="space-y-5" @submit.prevent="handleSubmit">
                            <div>
                                ...
                                <template v-if="v$.email.$error">
                                    <p class="mt-1 text-danger text-sm" v-for="error in v$.email.$errors" :key="error.$uid">
                                        {{ error.$message }}
                                    </p>
                                </template>
                            </div>
                            ...
                            >
                                ...
                                {{ authStore.isLoading ? 'SENDING...' : 'RECOVER' }}
                            </button>
                        </form>
