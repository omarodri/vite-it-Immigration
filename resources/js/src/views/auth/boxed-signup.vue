                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Enter your information to create an account</p>
                        </div>
                        <form class="space-y-5 dark:text-white" @submit.prevent="handleSubmit">
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input v-model="form.terms" type="checkbox" class="form-checkbox bg-white dark:bg-black" />
                                    <span class="text-white-dark">I agree to the terms and conditions</span>
                                </label>
                                <template v-if="v$.terms.$error">
                                    <p class="text-danger mt-1 text-sm">You must accept the terms and conditions</p>
                                </template>
                            </div>
                            <button
                                type="submit"
...
<script lang="ts" setup>
    ...
    const rules = computed(() => ({
        ...
        terms: { required: (value: boolean) => value === true },
    }));
